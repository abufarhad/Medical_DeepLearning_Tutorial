...
import _pickle as pickle # python 3.6
import shutil
import sys
import time
...
def train():
  ...
  # data_path = "/media/dhlee/0f737a3f-358d-45e0-827c-473d6a7d555b/MICCAI_Challenge/Endoscopy_Workflow/Software/ENAS/data/cifar10/"
  # if FLAGS.child_fixed_arc is None:
...
def main(_):
  ...
  # output_path = "/media/dhlee/0f737a3f-358d-45e0-827c-473d6a7d555b/MICCAI_Challenge/Endoscopy_Workflow/Software/ENAS/outputs/"
  # if not os.path.isdir(output_path):
  #   print("Path {} does not exist. Creating.".format(output_path))
  #   os.makedirs(output_path)
  # elif FLAGS.reset_output_dir:
  #   print("Path {} exists. Remove and remake.".format(output_path))
  #   shutil.rmtree(output_path)
  #   os.makedirs(output_path)
  #
  #
  # print("-" * 80)
  # log_file = os.path.join(output_path, "stdout")
  # print("Logging to {}".format(log_file))
  # sys.stdout = Logger(log_file)
  #
  # utils.print_user_flags()
